...
function load_shift8_jenkins_wp_admin_style() {
        // admin always last
        wp_enqueue_style( 'shift8_jenkins_css', plugin_dir_url(dirname(__FILE__)) . 'css/shift8_jenkins_admin.css' );
        wp_enqueue_script( 'shift8_jenkins_script', plugin_dir_url(dirname(__FILE__)) . 'js/shift8_jenkins_admin.js' );
